...
#
# DEV environment — Terraform provisions infrastructure ONLY.
# All Kubernetes + HAProxy configuration is handled by Ansible.
#
# After terraform apply:
#   1. Run: terraform output -json > ansible/inventory/tf_outputs.json
#   2. Run: cd ansible && ansible-playbook playbooks/site.yml
# =============================================================================
