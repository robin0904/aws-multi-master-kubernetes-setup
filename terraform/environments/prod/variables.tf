...
# NOTE: admin_cidr_block and api_access_cidr have NO defaults — must be
# explicitly set in terraform.tfvars for production.
# =============================================================================
...
# NO defaults — must be set explicitly in prod
...
variable "ssh_public_key_path" {
  type    = string
  default = "~/.ssh/k8s-prod-key.pub"
}

variable "generated_key_path" {
  type    = string
  default = "~/.ssh/k8s-prod-generated-key.pem"
}
