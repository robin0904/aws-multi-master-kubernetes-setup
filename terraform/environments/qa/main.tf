...
#
# Root module for the QA environment.
# QA mirrors the prod topology but uses smaller instances.
# HA NAT Gateway is enabled to match production routing behaviour.
# =============================================================================
